...
const STRINGS = {
  bg: {
    ...
    promo_reg_title: '💾 Искаш ли да си запазваш и следиш поканите?',
    promo_reg_desc: 'Създай си безплатен профил! Когато имаш профил, всички твои покани се запазват на едно място в твоето табло (Dashboard). Вече няма да има нужда да пазиш дългите линкове за отговорите на листче или в чатове, и ще виждаш статистика на живо за отговорите по всяко време!',
    promo_reg_btn: 'Регистрирай се и запази поканите си',
    showcase_title: 'Информация',
    showcase_hide: 'Скрий информацията',
    ...
    showcase_feature_4_title: '📖 Как работи стъпка по стъпка?',
    showcase_feature_4_desc: 'Виж бързото ръководство как да създадеш покана, да я изпратиш, как твоят човек отговаря с усмивка и как да проследиш резултата.',
    showcase_feature_5_title: '🔒 Сигурност & Защита',
    showcase_feature_5_desc: 'Твоите покани са напълно поверителни. Само ти и получателят разполагате с уникалния линк. Данните са защитени.',
    showcase_demo_dodge_counter: 'Опити за бягство: ',
    showcase_demo_accepted: 'Среща на: ',
    showcase_demo_how_title: '📖 Как работи?',
    showcase_demo_how_subtitle: 'ПРОЦЕС В 4 СТЪПКИ',
    showcase_demo_how_step_1: 'Създай поканата',
    showcase_demo_how_step_2: 'Изпрати линка',
    showcase_demo_how_step_3: 'Получи отговор',
    showcase_demo_how_step_4: 'Виж детайлите',
    showcase_demo_sec_title: '🔒 Защита & Данни',
    showcase_demo_sec_subtitle: 'СИГУРНОСТ',
    showcase_demo_sec_item_1_title: '100% Лично пространство',
    showcase_demo_sec_item_1_desc: 'Уникални криптирани линкове',
    showcase_demo_sec_item_2_title: 'Без спам или пароли',
    showcase_demo_sec_item_2_desc: 'Бързо и анонимно създаване',
    showcase_demo_sec_item_3_title: 'Сигурно съхранение',
    showcase_demo_sec_item_3_desc: 'Всички данни са защитени',
    showcase_demo_sec_footer: 'SSL Защитена Връзка 🔐',
  ...
  en: {
    ...
    promo_reg_title: '💾 Want to save and track your invitations?',
    promo_reg_desc: 'Create a free profile! Once you have a profile, all your invitations are saved in one place in your Dashboard. You won\'t need to manually keep track of long response links anymore, and you can view live statistics and answers at any time!',
    promo_reg_btn: 'Register and save your invites',
    showcase_title: 'Information',
    showcase_hide: 'Hide information',
    ...
    showcase_feature_4_title: '📖 How it works step by step?',
    showcase_feature_4_desc: 'See a quick guide on how to create an invitation, send it, how your person responds with a smile, and how to track the response.',
    showcase_feature_5_title: '🔒 Security & Privacy',
    showcase_feature_5_desc: 'Your invitations are completely private. Only you and the recipient have the unique link. All data is securely stored.',
    showcase_demo_dodge_counter: 'Attempts to dodge: ',
    showcase_demo_accepted: 'Date set for: ',
    showcase_demo_how_title: '📖 How it works?',
    showcase_demo_how_subtitle: '4-STEP PROCESS',
    showcase_demo_how_step_1: 'Create invite',
    showcase_demo_how_step_2: 'Send the link',
    showcase_demo_how_step_3: 'Get response',
    showcase_demo_how_step_4: 'See details',
    showcase_demo_sec_title: '🔒 Privacy & Data',
    showcase_demo_sec_subtitle: 'SECURITY GATE',
    showcase_demo_sec_item_1_title: '100% Private link',
    showcase_demo_sec_item_1_desc: 'Unique encrypted links',
    showcase_demo_sec_item_2_title: 'No spam or passwords',
    showcase_demo_sec_item_2_desc: 'Fast & anonymous creation',
    showcase_demo_sec_item_3_title: 'Secure storage',
    showcase_demo_sec_item_3_desc: 'All data is protected',
    showcase_demo_sec_footer: 'SSL Encrypted Connection 🔐',
